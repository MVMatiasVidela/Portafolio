...
const About = () => {
  return (
    <div
      className="max-w-[1000px]  flex justify-center flex-col mt-4 p-8 gap-4 m-auto bg-darkD-500 rounded "
    >
      <h1 className="text-2xl">Sobre mi</h1>
      ...
      <div className="space-y-4">
        ...
        <p>
          En el mismo bootcamp estoy a punto de terminar una emocionante etapa
          en mi carrera como Teaching Assistant. Estoy emocionado por esta
          oportunidad de devolver a la comunidad educativa parte de lo que he
          aprendido y ayudar a otros a alcanzar sus objetivos en el mundo del
          desarrollo de software.
        </p>
        <p>
          Mi trayectoria refleja una combinación de resiliencia, adaptabilidad y
