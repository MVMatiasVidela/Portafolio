...
const Cursos = () => {
  return (
    <div className=" rounded bg-black/30 flex justify-center flex-col m-auto gap-4 p-8 transition-shadow duration-300 hover:shadow-lg hover:shadow-white/50">
      ...
      <div className="border ml-8 sm:w-[30%] md:w-[30%] lg:w-[40%] rounded-3xl p-1 text-center m-4 transition-shadow duration-300 hover:shadow-lg hover:shadow-indigo-700/50">
        <Link href="/cursos">
