...
const Navbar = () => {
  ...
  return (
    <div className="bg-darkD-500 flex flex-col sm:flex-row justify-between w-full">
      ...
      <div
        className={`text-sky-200 text-xl flex-col sm:flex-row flex m-4 mr-10 justify-center items-center ${
          isOpen ? "flex" : "hidden"
        } sm:flex`}
      >
